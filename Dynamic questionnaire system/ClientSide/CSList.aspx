...
<body>
    <form id="form1" runat="server">
        <div class="auto-style1" style="border: thin solid #000000" >
            ...
            <asp:Label ID="lblStart" runat="server" Text="開始/結束時間："></asp:Label>
            <asp:TextBox ID="txtStart" runat="server" TextMode="Date" ToolTip="開始時間"></asp:TextBox>&nbsp;&nbsp;
            <asp:TextBox ID="txtEnd" runat="server" TextMode="Date" ToolTip="結束時間"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <uc1:ucPager runat="server" ID="ucPager" PageSize ="10" Url="/ClientSide/CSList.aspx" />
    </form>
</body>
</html>
